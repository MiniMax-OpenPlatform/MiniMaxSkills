...
Choosing the right voice for your project is easy! Follow this two ways:

**Way 1: Search in Voice Recommendation**  
Start with the **[Voice Recommendation](#voice-recommendation)** section, which gives recommended voices by content type and characteristics. If you don't find a suitable voice (language-matched, content-matched, characteristics-matched), browse the **[System Voices List (categorized by language)](#system-voices-list-categorized-by-language)** section.

**Way 2: Browse System Voices List**  
If you don't find a suitable voice in the recommendation, browse the **[System Voices List (categorized by language)](#system-voices-list-categorized-by-language)** section.
...
- Characteristics: Sustained performance, clear articulation, good pacing
...
| voice_id | Name | Description | Best For | Language |
|----------|------|-------------|----------|----------|
| `male-qn-jingying` | 精英青年 | Elite, ambitious young man voice | Business, professional content | Chinese (Mandarin) |
| `Chinese (Mandarin)_News_Anchor` | 新闻女声 | News anchor female voice | News broadcasts, current affairs | Chinese (Mandarin) |
| `Chinese (Mandarin)_Male_Announcer` | 播报男声 | Male announcer voice | Announcements, broadcasts | Chinese (Mandarin) |
| `Chinese (Mandarin)_Reliable_Executive` | 沉稳高管 | Reliable executive voice | Corporate, business content | Chinese (Mandarin) |
| `Cantonese_ProfessionalHost（F)` | 专业女主持 | Professional female host voice | Cantonese broadcasts, hosting | Chinese (Cantonese) |
| `Cantonese_ProfessionalHost（M)` | 专业男主持 | Professional male host voice | Cantonese broadcasts, hosting | Chinese (Cantonese) |
| `English_Trustworthy_Man` | Trustworthy Man | Reliable, sincere male voice | Business, narration | English |
| `French_Male_Speech_New` | Level-Headed Man | Calm, reasonable male voice | Professional, narration | French |
| `Japanese_CalmLady` | Calm Lady | Composed, serene female voice | Meditation, relaxation | Japanese |
| `Korean_CalmGentleman` | Calm Gentleman | Composed, refined gentleman voice | Formal, professional | Korean |
| `Spanish_CaptivatingStoryteller` | Captivating Storyteller | Engaging, magnetic narrator voice | Audiobooks, storytelling | Spanish |
| `Portuguese_Narrator` | Narrator | Professional narrative voice | Documentaries, narration | Portuguese |
| `Italian_Narrator` | Narrator | Professional narrative voice | Documentaries, storytelling | Italian |
| `Polish_male_1_sample4` | Male Narrator | Professional narrative voice | Documentaries, narration | Polish |
| `Hindi_female_1_v2` | News Anchor | Professional news anchor voice | News, broadcasts | Hindi |
...
| `male-qn-qingse-jingpin` | 青涩青年-beta | Youthful voice (enhanced version) | Campus stories, improved quality |
| `male-qn-jingying-jingpin` | 精英青年-beta | Elite voice (enhanced version) | Professional, enhanced quality |
| `male-qn-badao-jingpin` | 霸道青年-beta | Arrogant voice (enhanced version) | Drama, enhanced quality |
| `male-qn-daxuesheng-jingpin` | 青年大学生-beta | Student voice (enhanced version) | Campus, enhanced quality |
| `female-shaonv-jingpin` | 少女-beta | Maiden voice (enhanced version) | Youth content, enhanced quality |
| `female-yujie-jingpin` | 御姐-beta | Mature woman (enhanced version) | Romance, enhanced quality |
| `female-chengshu-jingpin` | 成熟女性-beta | Mature woman (enhanced version) | Adult content, enhanced quality |
| `female-tianmei-jingpin` | 甜美女性-beta | Sweet voice (enhanced version) | Soft content, enhanced quality |
...
| Voice Category | Best For | Key Characteristics | Recommended Voices |
|----------------|----------|-------------------|-------------------|
| **Audiobooks** | Long-form narration | Sustained performance, clear articulation | `Chinese (Mandarin)_Gentleman`, `Spanish_CaptivatingStoryteller` |
| **Business** | Corporate content | Authoritative, professional | `male-qn-jingying`, `English_Trustworthy_Man` |
| **Children** | Kids' content | Warm, engaging, friendly | `female-tianmei`, `cute_boy`, `Korean_SweetGirl` |
| **Entertainment** | Casual content | Energetic, fun | `Chinese (Mandarin)_Humorous_Elder`, `Japanese_GenerousIzakayaOwner` |
| **News** | Announcements | Clear, authoritative | `Chinese (Mandarin)_News_Anchor`, `French_Female_News Anchor` |
| **Romance** | Dating content | Warm, emotional | `junlang_nanyou`, `Korean_CheerfulBoyfriend` |
| **Education** | Learning materials | Clear, patient | `Japanese_IntellectualSenior`, `Portuguese_GentleTeacher` |

## Voice IDs for Quick Reference

### Most Popular Voices

**Male Voices:**
- `male-qn-qingse` - Youthful, versatile
- `male-qn-jingying` - Professional, business
- `Chinese (Mandarin)_Gentleman` - Narration, storytelling
- `English_Trustworthy_Man` - Reliable, sincere
- `Korean_CalmGentleman` - Formal, refined

**Female Voices:**
- `female-shaonv` - Youthful, sweet
- `female-yujie` - Mature, elegant
- `Chinese (Mandarin)_News_Anchor` - Professional, authoritative
- `Korean_SweetGirl` - Adorable, friendly
- `Spanish_SereneWoman` - Calm, peaceful

**Specialty Voices:**
- `clever_boy` - Children's educational
- `cartoon_pig` - Comedy, animations
- `Robot_Armor` - Sci-fi, game characters
- `Japanese_LoyalKnight` - Fantasy, game characters
- `Italian_WanderingSorcerer` - Fantasy, adventure

---

*Last Updated: February 2025*
*For the latest voice updates and new releases, check the MiniMax Platform Documentation.*
